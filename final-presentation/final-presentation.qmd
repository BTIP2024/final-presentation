...
## R is an open, purpose-designed, highly extensible, statistical and data analysis programming language that enables research reproducibility from its extensive and comprehensive data management capabilities. {style="font-size: 30px; top: 100px;" data-background="final-presentation_files/img/subtopic-slide-2-1.png" transition="fade-in slide-out" transition-speed="slow"}

::: {class="columns"}
:::: {class="column"}
![](final-presentation_files/img/rstudio1.webp)
::::
:::: {class="column"}
![](final-presentation_files/img/rstudio2.png){width=50% style="display: block; margin-left: auto; margin-right: auto;"}
::::
:::
...
![](final-presentation_files/img/proscons.webp)
...
![](final-presentation_files/img/scrna.jpg)
...
![](final-presentation_files/img/steps_projectdev.png)
...
::: {class="columns"}
:::: {class="column"}
![](final-presentation_files/img/soc.png)
::::
:::: {class="column"}
![](final-presentation_files/img/separation_concerns.png){width=50% style="display: block; margin-left: auto; margin-right: auto;"}
::::
:::
...
![](final-presentation_files/img/reproducible.png)
...
![](final-presentation_files/img/pipeline.png)

![](final-presentation_files/img/flow.png)
...
![](final-presentation_files/img/shiny-adv.png)
...
::: {class="columns"}
:::: {class="column"}
![](final-presentation_files/img/docker.webp)
::::
:::: {class="column"}
![](final-presentation_files/img/docker.png){width=50% style="display: block; margin-left: auto; margin-right: auto;"}
::::
:::
...
![](final-presentation_files/img/script.png)
...
![](final-presentation_files/img/packages.png)
...
![](final-presentation_files/img/dockerfile.png)

![](final-presentation_files/img/docker_container.png)
...
![](final-presentation_files/img/dockersteps.png)
...
::: {class="columns"}
:::: {class="column"}
![](final-presentation_files/img/api0.png)
::::
:::: {class="column"}
![](final-presentation_files/img/api2.png){width=50% style="display: block; margin-left: auto; margin-right: auto;"}
::::
:::
...
![](final-presentation_files/img/servers_on_web.png)
...
![](final-presentation_files/img/automated_pipeline.png)
...
![](final-presentation_files/img/final_photo.png)
